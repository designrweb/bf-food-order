        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <b-form @submit="onSubmit" @reset="onReset" v-if="!isPageBusy">
                    ...
                    <b-button id="subsidized-menu-category-submit-btn" type="submit" variant="primary">Einreichen</b-button>
                </b-form>
            </div>
        </div>
    </div>
...
export default {
    ...
    data() {
        return {
            ...
            form:       {},
            validation: {
                'id': {'state': true, 'message': ''}, 'subsidization_rule_id': {'state': true, 'message': ''}, 'menu_category_id': {'state': true, 'message': ''}, 'percent': {'state': true, 'message': ''}, 'created_at': {'state': true, 'message': ''}, 'updated_at': {'state': true, 'message': ''},
            },
        }
    },
    methods: {
