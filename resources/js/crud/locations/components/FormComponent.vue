    ...
    export default {
        ...
        data() {
            return {
                ...
                form:         {},
                validation:   {
            'id':{'state': true,'message': ''},'name':{'state': true,'message': ''},'street':{'state': true,'message': ''},'zip':{'state': true,'message': ''},'city':{'state': true,'message': ''},'email':{'state': true,'message': ''},'slug':{'state': true,'message': ''},'image_name':{'state': true,'message': ''},
                },
            }
        },
        methods:    {
