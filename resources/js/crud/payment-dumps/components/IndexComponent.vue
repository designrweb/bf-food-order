<template>
    <div class="card">
        <div class="card-header" v-if="!isPageBusy">
            ...
            <create-button v-if="allowActions.create && allowActions.all"
                           :mainRoute="main_route"></create-button>
        </div>
        <div class="card-body overflow-auto">
            <b-form @submit="onSubmit">
                ...
                <b-form-group>
                    <b-button id="payment-dumps-submit-btn" type="submit" variant="success">
                        Hochladen
                    </b-button>
                </b-form-group>
            </b-form>
            ...
            <b-table
                    ...
                    <b-th v-for="field in scope.fields" v-bind:key="field.key">
                        <div v-if="field.key in filters">
                            <filter-form-date-picker
                                v-if="field.key === 'requested_at' || field.key === 'created_at'  || field.key === 'updated_at'"
                ...
                <template v-slot:cell()="data">
                    <div v-if="data.field.key ==='actions'" class="d-flex">
                        ...
                        <process-button v-if="allowActions.process && data.item.status ==
                        'UPLOADED'"
                                        :mainRoute="main_route"
                                        :id="data.item.id"></process-button>
                    </div>
                    <div v-else>
                        {{ data.value }}
                    </div>
...
import FilterSelectInput
                                                                           from "../../shared/filters/SelectFilterComponent";
import {CreateButton, ViewButton, EditButton, DeleteButton, ProcessButton} from
                                                                               "../../shared/grid-buttons";
import {
    getStructure,
    getItems,
...
import FormDatePickerFilterComponent
                                                                           from "../../shared/filters/FormDatePickerFilterComponent";
import PaginationInfoComponent
                                                                           from "../../shared/PaginationInfoComponent";
