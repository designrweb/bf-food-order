        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <b-form @submit="onSubmit" @reset="onReset" v-if="!isPageBusy">
                    ...
                    <b-button id="subsidization-submit-btn" type="submit" variant="primary">Einreichen</b-button>
                </b-form>
            </div>
        </div>
    </div>
    ...
    data() {
        return {
            ...
            validation: {
                ...
                'subsidization_rule_id':  {'state': true, 'message': ''},
                'subsidization_start':    {'state': true, 'message': ''},
                'subsidization_end':      {'state': true, 'message': ''},
                'subsidization_document': {'state': true, 'message': ''},
