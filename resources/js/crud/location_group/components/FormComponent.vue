    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <b-form @submit="onSubmit" @reset="onReset" v-if="!isPageBusy">
          ...
          <b-button id="location-groups-submit-btn" type="submit" variant="primary">Einreichen</b-button>
        </b-form>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      form:       {},
      validation: {
        'id': {'state': true, 'message': ''}, 'location_id': {'state': true, 'message': ''}, 'name': {'state': true, 'message': ''},
      },
    }
  },
  methods: {
