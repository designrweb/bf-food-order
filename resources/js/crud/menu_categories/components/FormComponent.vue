    ...
    export default {
        ...
        data() {
            return {
                ...
                form:         {},
                validation:   {
            'id':{'state': true,'message': ''},'name':{'state': true,'message': ''},'category_order':{'state': true,'message': ''},'price':{'state': true,'message': ''},'presaleprice':{'state': true,'message': ''},'created_at':{'state': true,'message': ''},'updated_at':{'state': true,'message': ''},
                },
            }
        },
        methods:    {
