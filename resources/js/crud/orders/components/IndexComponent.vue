            ...
            <b-table
                ...
                <template v-slot:cell()="data">
                    <div v-if="data.field.key ==='actions'" class="d-flex">
                        ...
                        <delete-button v-if="allowActions.delete && isPermitToCancelItem(data.item.day_machine)" :mainRoute="main_route"
...
export default {
    ...
    methods: {
        isPermitToCancelItem(day) {
            return isPermitToCancelItem(moment(day).toString());
        },
