    ...
    export default {
        ...
        data() {
            return {
                ...
                form:         {},
                validation:   {
            'id':{'state': true,'message': ''},'account_id':{'state': true,'message': ''},'firstname':{'state': true,'message': ''},'lastname':{'state': true,'message': ''},'birthday':{'state': true,'message': ''},'imageurl':{'state': true,'message': ''},'balance':{'state': true,'message': ''},'balance_limit':{'state': true,'message': ''},'location_group_id':{'state': true,'message': ''},'user_id':{'state': true,'message': ''},'created_at':{'state': true,'message': ''},'updated_at':{'state': true,'message': ''},'deleted_at':{'state': true,'message': ''},
                },
            }
        },
        methods:    {
